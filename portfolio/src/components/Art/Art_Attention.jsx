...
function Art_Attention() {
  return (
    ...
    <div className="flex flex-col gap-4 lg:max-w-1/2 p-4">
      ...
      <div className="lg:grid lg:grid-cols-2 border-2 p-4 gap-4">
        <div>
          ...
          <p >
            ...
            "INSTRUCTION BOOK FOR PROCTORS OF GUIDED VIEWING EXPERIENCE." <span className="font-bold">CLICKING
            ON THE IMAGE</span> WILL ALLOW YOU TO VIEW THE BOOK IN ITS ENTIRETY.
          </p>
        </div>
      ...
      <div className="lg:grid lg:grid-cols-2 border-2 p-4 gap-4">
        <div>
          ...
          <p >
            ...
            FILE. <span className="font-bold">CLICKING ON THE IMAGE </span> WILL ALLOW YOU TO VIEW THE
      ...
      <div className="lg:grid lg:grid-cols-2 border-2 p-4 gap-4">
        <div>
          <h2 className="font-bold">PART FIVE: THE CASSETTE</h2>
          <p >
      ...
      <div className="lg:grid lg:grid-cols-2 border-2 p-4 gap-4">
        <div>
          ...
          <p >
            ...
            PARTICIPATED IN THE ORIGINAL "ATTENTION!" PRESENTATION). 
            <span className="font-bold">CLICKING ON THE IMAGE </span> 
            WILL ALLOW YOU TO VIEW THE RESPONSES.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 border-2 p-4 gap-4">
        <div>
          ...
          <p >
            ...
            PLEASED WITH THE RESULTS, AESTHETICALLY AND CONTENT-WISE."
          </p>
